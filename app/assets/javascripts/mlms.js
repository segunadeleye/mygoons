...
class Mlm {
  ...
  init() {  
    ...
    const regexPercent = /([0-9]{1,2})(\.[0-9]{1,2})?/;
    ...
    $('#dd_comm_id').keyup(function() {
      ...
      if(self.ddComm.length == 0) {
        ...
        let htmlPercentAssigned = `<p style="color:green">Assigned: ${self.percentageAssigned}%</p>`;
        let htmlPercentRemain = `<p style="color:olive">Overflow: ${self.percentageOverflow}% <sub>will be added to Deal Dey account</sub></p>`;
